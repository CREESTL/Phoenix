...
async function triggerEvents() {
  ...
  console.log(
    "Wallet ULX balance before swap is ",
    formatEther(await wallet.getBalance())
  );
  console.log(
    "Wallet USDT balance before swap is ",
  ...
  console.log(
    "Wallet ULX balance after swap is ",
    formatEther(await wallet.getBalance())
  );
  console.log(
    "Wallet USDT balance after swap is ",
    formatUnits(await USDT.balanceOf(wallet.address), 6)
  );
  ...
  console.log(
    "Wallet USDC balance before swap is ",
  ...
  console.log(
    `USDT balance of the wallet before adding:`,
    formatUnits(await USDT.balanceOf(wallet.address), 6)
  );
  console.log(
    `USDT balance of the pair before adding:`,
    formatUnits(await USDT.balanceOf(pair.address), 6)
  );
  console.log(
    `USDC balance of the pair before adding:`,
  ...
  console.log(
    `USDT balance of the wallet after adding:`,
    await formatUnits(await USDT.balanceOf(wallet.address), 6)
  );
  console.log(
    `USDT balance of the pair after adding:`,
    formatUnits(await USDT.balanceOf(pair.address), 6)
  );
  console.log(
    `USDC balance of the pair after adding:`,
    formatUnits(await USDC.balanceOf(pair.address), 6)
  );
  await delay(5000);
  ...
  console.log(
    `USDT balance of the pair before swapping:`,
    formatUnits(await USDT.balanceOf(pair.address), 6)
  );
  console.log(
    `USDC balance of the pair before swapping:`,
    formatUnits(await USDC.balanceOf(pair.address), 6)
  );
  path = [USDT.address, USDC.address];
  // We have to approve USDT
  approveTx = await USDT.connect(wallet).approve(
    router.address,
    amountTokenDesired
  );
  approveReceipt = await approveTx.wait();
  ...
  console.log("Swap finished!");
  console.log(
    `USDT balance of the pair after swapping:`,
    formatUnits(await USDT.balanceOf(pair.address), 6)
  );
  console.log(
    `USDC balance of the pair after swapping:`,
    formatUnits(await USDC.balanceOf(pair.address), 6)
  );
  await delay(5000);
  ...
  console.log(
    `USDT balance of the pair before liquidity withdrawal:`,
    formatUnits(await USDT.balanceOf(pair.address), 6)
  );
  console.log(
    `USDC balance of the pair before liquidity withdrawal:`,
    formatUnits(await USDC.balanceOf(pair.address), 6)
  );
  console.log(
    `USDC balance of the wallet before liquidity withdrawal:`,
    formatUnits(await USDC.balanceOf(wallet.address), 6)
  );
  console.log(
    `LP tokens balance of the user before liquidity withdrawal`,
    formatUnits(await pair.balanceOf(wallet.address), 18)
  );
  ...
  console.log(
    `USDT balance of the pair after liquidity withdrawal:`,
    formatUnits(await USDT.balanceOf(pair.address), 6)
  );
  console.log(
    `USDC balance of the pair after liquidity withdrawal:`,
    formatUnits(await USDC.balanceOf(pair.address), 6)
  );
  console.log(
    `USDC balance of the wallet after liquidity withdrawal:`,
    formatUnits(await USDC.balanceOf(wallet.address), 6)
  );
  console.log(
    `LP tokens balance of the user after liquidity withdrawal`,
    formatUnits(await pair.balanceOf(wallet.address), 18)
  );
}
